...
<style>
  ...
  /* ── Sidebar: pipeline image background + dark overlay ── */
  [data-testid="stSidebar"] {
    background-image:
      linear-gradient(rgba(0,0,0,0.72), rgba(180,0,0,0.55)),
      url('https://images.unsplash.com/photo-1518709268805-4e9042af9f23?w=600&auto=format&fit=crop') !important;
